...
class Ui_OpenedNoteDialog(object):
    def setupUi(self, OpenedNoteDialog):
        ...
        self.notebooks_comboBox = QtWidgets.QComboBox(parent=self.MoveNoteWidget)
        self.notebooks_comboBox.setMaximumSize(QtCore.QSize(16777215, 50))
        self.notebooks_comboBox.setObjectName("notebooks_comboBox")
        self.verticalLayout_3.addWidget(self.notebooks_comboBox)
