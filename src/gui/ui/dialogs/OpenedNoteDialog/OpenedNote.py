...
class Ui_OpenedNoteDialog(object):
    def setupUi(self, OpenedNoteDialog):
        ...
        self.gridLayout.addWidget(self.DescriptionWidget, 3, 0, 1, 1)
        ...
        self.noteTitle_lineEdit.setMaximumSize(QtCore.QSize(16777215, 45))
        ...
        self.MoveNoteWidget = QtWidgets.QWidget(parent=OpenedNoteDialog)
        self.MoveNoteWidget.setObjectName("MoveNoteWidget")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.MoveNoteWidget)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.moveNoteTitle_label = QtWidgets.QLabel(parent=self.MoveNoteWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.moveNoteTitle_label.sizePolicy().hasHeightForWidth())
        self.moveNoteTitle_label.setSizePolicy(sizePolicy)
        self.moveNoteTitle_label.setObjectName("moveNoteTitle_label")
        self.verticalLayout_3.addWidget(self.moveNoteTitle_label)
        self.moveNote_comboBox = QtWidgets.QComboBox(parent=self.MoveNoteWidget)
        self.moveNote_comboBox.setMaximumSize(QtCore.QSize(16777215, 45))
        self.moveNote_comboBox.setObjectName("moveNote_comboBox")
        self.verticalLayout_3.addWidget(self.moveNote_comboBox)
        self.gridLayout.addWidget(self.MoveNoteWidget, 2, 0, 1, 1)
    ...
    def retranslateUi(self, OpenedNoteDialog):
        ...
        self.moveNoteTitle_label.setText(_translate("OpenedNoteDialog", "TextLabel"))
