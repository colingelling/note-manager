...
class Ui_OpenedNoteDialog(object):
    def setupUi(self, OpenedNoteDialog):
        ...
        self.moveOption_label = QtWidgets.QLabel(parent=self.MoveNoteWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.moveOption_label.sizePolicy().hasHeightForWidth())
        self.moveOption_label.setSizePolicy(sizePolicy)
        self.moveOption_label.setObjectName("moveOption_label")
        self.verticalLayout_3.addWidget(self.moveOption_label)
    ...
    def retranslateUi(self, OpenedNoteDialog):
        ...
        self.moveOption_label.setText(_translate("OpenedNoteDialog", "TextLabel"))
